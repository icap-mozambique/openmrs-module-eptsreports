...
public class TxNewCommunityDataset extends BaseDataSet {
  ...
  public DataSetDefinition constructTxNewDataset() {
    ...
    final CohortDefinition patientWithLessCD4Definition =
        this.txNewCohortQueries.findPatientsWithCD4LessThan200Community();
    ...
    final CohortDefinition patientWithGreaterCD4Definition =
        this.txNewCohortQueries.findPatientsWIthCD4GreaterOrEqual200Community();
    ...
    final CohortDefinition patientsWithUnknownCD4Definition =
        this.txNewCohortQueries.findPatientsWithUnknownCD4Community();
