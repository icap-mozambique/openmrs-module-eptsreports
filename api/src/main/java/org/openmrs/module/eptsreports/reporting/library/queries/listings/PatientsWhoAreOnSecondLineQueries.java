...
public interface PatientsWhoAreOnSecondLineQueries {

  class QUERY {
    public static final String findPatientsWhoAreOnSecondLine =
        "select *\n"
            + "from\n"
            ...
            + "		inner join \n"
            + "		(\n"
            + "			select Linha.patient_id,Linha.encounter_datetime \n"
            + "			from \n"
            + "			(	\n"
            ...
            + "						e.encounter_datetime<=:endDate and o.voided=0 and o.concept_id=21151 \n"
            + "				group by p.patient_id\n"
            + "			) Linha \n"
            + "			inner join obs obsSegunda on obsSegunda.person_id=Linha.patient_id and obsSegunda.obs_datetime=Linha.encounter_datetime\n"
            + "			where obsSegunda.concept_id=21151 and obsSegunda.value_coded=21148 and obsSegunda.voided=0 and obsSegunda.location_id=:location\n"
            + "			group by Linha.patient_id\n"
            + "			\n"
            + "			union\n"
            + "			\n"
            + "			select 	p.patient_id,max(o.obs_datetime) as encounter_datetime\n"
            + "			from 	patient p					 \n"
            + "					inner join encounter e on p.patient_id=e.patient_id \n"
            + "					inner join obs o on o.encounter_id=e.encounter_id\n"
            + "			where 	e.voided=0 and p.voided=0 and e.encounter_type=53 and e.location_id=:location and \n"
            + "					o.obs_datetime<=:endDate and o.voided=0 and o.concept_id=21187 \n"
            + "			group by p.patient_id\n"
            + "			\n"
            + "		) LinhaTarv on LinhaTarv.patient_id=inicio_real.patient_id\n"
            ...
            + "		) pid on pid.patient_id=LinhaTarv.patient_id\n"
            + "		left join \n"
            + "		(	select pn1.*\n"
            ...
            + "		) pn on pn.person_id=LinhaTarv.patient_id\n"
            + "		left join \n"
            + "		(	select pad1.*\n"
            ...
            + "		) pe on pe.person_id=LinhaTarv.patient_id		\n"
            + "	left join\n"
            + "		(		\n"
            ...
            + "			\n"
            + "			select 	p.patient_id,\n"
            + "					o.obs_datetime encounter_datetime,\n"
            + "					case o.value_coded\n"
            + "						when 1706 then 'TRASFERIDO PARA'\n"
            ...
            + "					inner join obs  o on e.encounter_id=o.encounter_id\n"
            + "			where 	e.voided=0 and o.voided=0 and p.voided=0 and \n"
            + "					e.encounter_type in (53,6) and o.concept_id in (6272,6273) and o.value_coded in (1706,1366,1709,1707) and  \n"
            ...
            + "		left join\n"
            + "		(		\n"
            + "			select person_id,min(data_inicio_segunda) data_inicio_segunda\n"
            + "			from \n"
            + "			(\n"
            + "				select 	p.patient_id person_id,min(encounter_datetime) as data_inicio_segunda\n"
            + "				from 	patient p					 \n"
            + "						inner join encounter e on p.patient_id=e.patient_id \n"
            + "						inner join obs o on o.encounter_id=e.encounter_id\n"
            + "				where 	e.voided=0 and p.voided=0 and e.encounter_type=6 and e.location_id=:location and \n"
            ...
            + "				union\n"
            + "				\n"
            + "				select 	p.patient_id person_id,min(o.obs_datetime) as data_inicio_segunda\n"
            + "				from 	patient p					 \n"
            + "						inner join encounter e on p.patient_id=e.patient_id \n"
            + "						inner join obs o on o.encounter_id=e.encounter_id\n"
            + "				where 	e.voided=0 and p.voided=0 and e.encounter_type=53 and e.location_id=:location and \n"
            ...
            + ") segundalinha group by patient_id";
  }
}
