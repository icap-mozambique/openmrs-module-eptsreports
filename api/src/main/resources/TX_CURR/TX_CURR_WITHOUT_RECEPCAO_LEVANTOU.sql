                         ...
                         (                                                                                                                                       
							 ...
							 from (
											...
											where e.voided=0 and o.voided=0 and p.voided=0                                                                
												and e.encounter_type in (53,6) and o.concept_id in (6272,6:location ) and o.value_coded = 1366                         
							...
							(
                             ...
                             where   e.voided=0 and o.voided=0 and p.voided=0 and                                                              
                                     e.encounter_type in (53,6) and o.concept_id in (6272,6:location ) and o.value_coded = 1709 and                        
			                           	...
			                           	from 
			                           		(                                                                
			                             		...
			                             		from patient p                                                                                                                   
			                                     	...
			                                     	inner join obs o on e.encounter_id=o.encounter_id                                                                          
			                             		where e.voided=0 and o.voided=0 and p.voided=0                                                                
			                                   	and e.encounter_type in (53,6) and o.concept_id in (6272,6:location ) and o.value_coded = 1706                         
			                                     	and o.obs_datetime<=:endDate   and e.location_id=:location                                                                         
			                             			group by p.patient_id                                                                                                               
