                      ...
                      inicio.confident_phone
                       ...
                       (
                          ...
                          pd_final.address1 AS 'reference',
                          pd_final.address2 as 'p_admin',
                          pd_final.address5 AS 'block',
                          pd_final.address6 AS 'locality',
                          confident.value_text AS 'confident_phone',
                          pat.value AS phone
                          from 
                          ( 
                       ...
                       SELECT f.patient_id, encounter_datetime, state_fr FROM (
                        ...
                        (	select pd.*                             
                         	...
                         	where pd.person_id=pd_min.person_id and pd.person_address_id=pd_min.id                             
                         ) pd_final on pd_final.person_id=inicio_real.patient_id
                        ...
                        LEFT JOIN
                        (  
                            SELECT o.person_id, o.value_text FROM obs o 
                                WHERE o.voided = 0 AND o.concept_id = 6224 AND o.value_text IS NOT NULL
                                GROUP BY o.person_id
                        )confident ON confident.person_id = inicio_real.patient_id
